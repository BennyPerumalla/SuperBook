...
export const DictionaryDemo = () => {
  ...
  const highlightWords = ['dictionary', 'extension', 'instant', 'definitions', 'webpage', 'highlighted'];
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-muted rounded-lg p-6 mt-8">
            ...
            <p className="text-base leading-relaxed">
              {[
                'magnificent', 'serendipity', 'ubiquitous', 'ephemeral', 'eloquent',
                'perseverance', 'pristine', 'mellifluous', 'enigmatic', 'sophisticated'
              ].map((word, index) => (
                <span key={index}>
                  <span
